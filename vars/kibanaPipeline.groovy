...
def withFunctionalTestEnv(List additionalEnvs = [], Closure closure) {
  ...
  // Keep 6x03-6x05 open for multi-node clusters
  def esTransportPort = "61${parallelId}6"
  def fleetPackageRegistryPort = "61${parallelId}7"
  def alertingProxyPort = "61${parallelId}8"
  def corsTestServerPort = "61${parallelId}9"
